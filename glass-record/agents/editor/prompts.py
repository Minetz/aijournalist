...
5. Advances the open questions listed above (if any) — prefer stories that close
   gaps in the investigation rather than opening entirely new threads
...
{{
  ...
  "advances_open_question": "Which open question (if any) does this story help answer, or 'none'."
}}
""".strip()
...
- Where relevant, designed to resolve open questions or deepen established facts listed above
